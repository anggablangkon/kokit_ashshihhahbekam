...
<form action="" method="" id="formKontributor" autocomplete="off">
    @csrf
    <div class="modal-body p-4">
       <div class="row mb-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control border-success" id="nama" name="nama" placeholder="Masukkan nama" required>
        </div>
        <div class="col-md-6">
            <label for="nohp" class="form-label">No. HP **</label>
            <input type="tel" class="form-control border-success" id="nohp" name="nohp" placeholder="08xxxxxxx" required>
        </div>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control border-success" id="nominal" name="nominal" placeholder="Masukkan total nominal" required>
    </div>
    <div class="mb-3">
        <label for="Domisili" class="form-label">Doa & Dukungan</label>
        <textarea class="form-control" name="dukungan"></textarea>
    </div>

    <div id="alert-success" style="display:none; color:green;">Terima kasih atas kontribusi Anda!</div>
    <div id="alert-error" style="display:none; color:red;"></div>

</div>

<div class="modal-footer px-4 pb-4">
  <button type="submit" id="pembayaran" class="btn btn-primary">Pembayaran / Transfer</button>
...
@section('js')
<script src="{{asset('/internal/js/kukumpul.js?v='.date('his'))}}"></script>
@endsection