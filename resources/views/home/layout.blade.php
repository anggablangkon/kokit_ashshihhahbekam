            ...
            <div class="container">
                <div class="auth-brand mb-0">
                    <a href="index.html" class="logo-dark">
                        {{-- <img src="{{asset('internal/assets/logo.png')}}" alt="dark logo" height="32"> --}}
                    </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav fw-medium fs-sm mx-auto mt-2 mt-lg-0 d-flex flex-column flex-lg-row align-items-center gap-2" id="navbar-example">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/profil') }}">Berkenalan dengan kami?</a>
                        </li>
                        <li class="nav-item d-none d-lg-block">
                            <a href="#" class="nav-link disabled">|</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/teknis') }}">Teknis & Alur</a>
                        </li>
                    </ul>
