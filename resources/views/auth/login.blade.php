<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="bg-white shadow  p-4 rounded-lg">
        @csrf

        <img class="text-center rounded-lg mx-auto" src="{{ asset('internal/assets/logoix.png') }}" alt="logo"
            width="100">
